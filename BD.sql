...
CREATE TABLE loja.cliente (
    ...
    CONSTRAINT fk_pedido_cliente FOREIGN KEY(id_pedido) REFERENCES loja.pedido(id)
);
...
CREATE TABLE loja.endereco (
    ...
    CONSTRAINT fk_cliente_endereco FOREIGN KEY(id_cliente) REFERENCES loja.cliente(id)
);
...
CREATE TABLE loja.pedido_tem_action_figure (
    ...
    CONSTRAINT fk_id_pedido FOREIGN KEY(id_pedido) REFERENCES loja.pedido(id),
